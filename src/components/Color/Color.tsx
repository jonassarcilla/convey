  ...
  return (
    <>
      <div className="grid-cols grid h-[100vh] justify-items-center gap-16 bg-[#3E3E3F] p-16 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 2xl:grid-cols-10">
        ...
        <div className="flex flex-col gap-8">
          <div className="h-[128px] w-[128px] bg-base-05" />
          <div className="flex flex-col gap-4">
            <h3 className="text-[24px] font-[700] leading-8 tracking-[-0.12px] text-[#ffffff] opacity-80">Base 05</h3>
            <p className="text-[20px] font-[700] leading-[32px] tracking-[-0.1px] text-[#ffffff] opacity-80">D4D4D4</p>
          </div>
        </div>
        <div className="flex flex-col gap-8">
          <div className="h-[128px] w-[128px] bg-base-06" />
          <div className="flex flex-col gap-4">
            <h3 className="text-[24px] font-[700] leading-8 tracking-[-0.12px] text-[#ffffff] opacity-80">Base 06</h3>
            <p className="text-[20px] font-[700] leading-[32px] tracking-[-0.1px] text-[#ffffff] opacity-80">CCCCCC</p>
          </div>
        </div>
        <div className="flex flex-col gap-8">
          <div className="h-[128px] w-[128px] bg-base-07" />
          <div className="flex flex-col gap-4">
            <h3 className="text-[24px] font-[700] leading-8 tracking-[-0.12px] text-[#ffffff] opacity-80">Base 07</h3>
            <p className="text-[20px] font-[700] leading-[32px] tracking-[-0.1px] text-[#ffffff] opacity-80">C6C6C6</p>
          </div>
        </div>
        <div className="flex flex-col gap-8">
          <div className="h-[128px] w-[128px] bg-base-07" />
          <div className="flex flex-col gap-4">
            <h3 className="text-[24px] font-[700] leading-8 tracking-[-0.12px] text-[#ffffff] opacity-80">Base 08</h3>
            <p className="text-[20px] font-[700] leading-[32px] tracking-[-0.1px] text-[#ffffff] opacity-80">BBBBBB</p>
          </div>
        </div>
      </div>
    </>
